...
conan remove consumer/poc@user/testing -f
...
conan export multi/consumer.py consumer/poc@user/testing
...
# ICU: requires >= C++11
conan create multi/icu.py icu/poc@user/testing --profile=profiles/cpp17
...
conan create multi/boost.py boost/poc@user/testing --profile=profiles/cpp17 -o boost:icu=True
conan create multi/boost.py boost/poc@user/testing --profile=profiles/cpp14 -o boost:icu=True
conan create multi/boost.py boost/poc@user/testing --profile=profiles/cpp11 -o boost:icu=True
